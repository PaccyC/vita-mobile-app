import { View, Text, TouchableOpacity, KeyboardAvoidingView, Platform, ScrollView, SafeAreaView, TextInput, Image } from 'react-native'
...
const OTP = () => {
  ...
  return (
    <SafeAreaView style={tw`flex flex-1  bg-white justify-between`}>
      ...
      style={tw`w-full  justify-center  items-start px-3 mb-5`}>
      ...
      <View style={tw`px-3`}>
        <Text style={[tw`text-3xl mb-4`,{fontFamily: "Jakarta-SemiBold"}]}>Send OTP Code</Text>
        <Text  style={[tw`text-gray-600 text-base mb-6 leading-5`,]}>
          Enter the 6-digit that we have sent via the
         phone number to {" "}
         <Text style={[tw``,{fontFamily:"Jakarta-Bold"}]}>+62 812- 2569 - 2023</Text>
         </Text>
      ...
      <View style={[tw`w-full px-3 items-center `,{position:"fixed",}]}>
      <CustomButton
         title='Continue'
